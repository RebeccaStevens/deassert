 ...
 */
export type ReadonlyScopeMap = ReadonlyMap<Readonly<acorn.Node>, Readonly<Scope>>;
 ...
 */
export type ReadonlyScopeToIdentifiersToRemoveMap = ReadonlyMap<ReadonlyScope, ReadonlyArray<string>>;
