...
[![npm version](https://img.shields.io/npm/v/deassert.svg)](https://www.npmjs.com/package/swc-plugin-deassert)
...
```sh
# Install with npm
npm install -D swc-plugin-deassert

# Install with pnpm
pnpm add -D swc-plugin-deassert

# Install with yarn
yarn add -D swc-plugin-deassert

# Install with bun
bun add -D swc-plugin-deassert
```
